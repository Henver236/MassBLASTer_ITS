...
# En sortie, on obtient une page HTML dynamique qui permet de visualiser les réultats, ainsi qu'un fichier CSV (.csv). 
...
# 2) transférer le fichier à traiter dans "~/unite-massblaster/massblaster_plutof_pub/indata".
# 3) ajouter "source_" au début du nom du fichier (ex: source_MonFichierFasta.fas)
...
# suprimant le snipet slurm au début du wrapper ~/unite-massblaster/launch-massblaster-v3.slurm.sh
